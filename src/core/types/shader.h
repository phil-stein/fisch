...
#define shader_set_bool(s, n, v) shader_set_bool_dbg(s, n, v, __FILE__, __LINE__)
...
#define shader_set_float(s, n, v) shader_set_float_dbg(s, n, v, __FILE__, __LINE__)
...
#define shader_set_vec2_f(s, n, x, y) shader_set_vec2_f(s, n, x, y, __FILE__, __LINE__)
...
#define shader_set_vec3_f(s, n, x, y, z) shader_set_vec3_f(s, n, x, y, z, __FILE__, __LINE__)
...
#define shader_set_mat4(s, n, v) shader_set_mat4_dbg(s, n, v, __FILE__, __LINE__)
